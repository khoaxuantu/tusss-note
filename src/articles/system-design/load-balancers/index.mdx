...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/load-balancers.webp"
  alt="Load balancer diagram"
  title="Load balancer diagram"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/load-balancers-1.webp"
  alt="Load balancer diagram"
  title="Load balancer diagram"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/load-balancers-2.webp"
  alt="Global server load balancing diagram"
  title="Global server load balancing diagram"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/load-balancers-3.webp"
  alt="Stateful load balancing diagram"
  title="Stateful load balancing diagram"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/load-balancers-4.webp"
  alt="Stateless load balancing diagram"
  title="Stateless load balancing diagram"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/load-balancers-5.webp"
  alt="Load balancer layers diagram"
  title="Load balancer layers diagram"
/>
