...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/rate-limiter-1.webp"
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/rate-limiter-2.webp"
  alt="Token bucket algorithm illustration"
  title="Token bucket algorithm illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/rate-limiter-3.webp"
  alt="Leaking bucket algorithm illustration"
  title="Leaking bucket algorithm illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/rate-limiter-4.webp"
  alt="Fixed window counter algorithm illustration"
  title="Fixed window counter algorithm illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/rate-limiter-5.webp"
  alt="Sliding window log algorithm illustration"
  title="Sliding window log algorithm illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/rate-limiter-6.webp"
  alt="Sliding window counter algorithm illustration"
  title="Sliding window counter algorithm illustration"
/>
