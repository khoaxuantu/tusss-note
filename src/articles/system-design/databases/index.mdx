...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases.webp"
  alt="Complex db model illustration"
  title="Complex db model illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-1.webp"
  alt="Database replication diagram"
  title="Database replication diagram"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-2.webp"
  alt="Synchronous vs asynchronous sequence diagram"
  title="Synchronous vs asynchronous sequence diagram"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-3.webp"
  alt="Primary-secondary replication diagram"
  title="Primary-secondary replication diagram"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-4.webp"
  alt="Multi-leader replication diagram"
  title="Multi-leader replication diagram"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-5.webp"
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-6.webp"
  alt="Peer-to-peer replication diagram"
  title="Peer-to-peer replication diagram"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-7.webp"
  alt="Quorums illustration"
  title="Quorums illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-8.webp"
  alt="Partition illustration"
  title="Partition illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-9.webp"
  alt="Vertical sharding illustration"
  title="An employee with name and picture can be sharded to a table containing profile information only and a table containing media data only"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-10.webp"
  alt="Key-range based sharding illustration"
  title="Key-range based sharding illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-11.webp"
  alt="Key-range based sharding illustration"
  title="Key-range based sharding illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-12.webp"
  alt="Hash based sharding illustration"
  title="Hash based sharding illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-13.webp"
  alt="Partition secondary indexes by document illustration"
  title="Partition secondary indexes by document illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-14.webp"
  alt="Partition secondary indexes by the term illustration"
  title="Partition secondary indexes by the term illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/databases-15.webp"
  alt="Database example image"
  title="Database example image"
/>
