...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/key-value-store.webp"
  alt="Consistent hashing illustration"
  title="Consistent hashing illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/key-value-store-1.webp"
  alt="Consistent hashing illustration"
  title="Các node có thể phân bố không được đồng đều với consistent hashing"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/key-value-store-2.webp"
  alt="Peer-to-peer approach illustration"
  title="Peer-to-peer approach illustration"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/system-designs/key-value-store-3.webp"
  alt="Merkle tree illustration"
  title="Merkle tree illustration"
/>
