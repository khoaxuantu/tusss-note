...
[.note] ##### Data temperature
Để diễn tả độ truy cập thường xuyên của dữ liệu, ta phân chia theo 3 mức sau: - **Hot:** Highly accessed data - **Warm:** Less frequently accessed data - **Cold:** Rarely accessed data
