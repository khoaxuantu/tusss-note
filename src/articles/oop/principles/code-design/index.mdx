...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/deep-inheritance.webp"
  alt="Deep inheritance example"
  title="Deep inheritance example (Source: Refactoring Guru)"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/composition-example.webp"
  alt="Composition example"
  title="Composition example (Source: Refactoring Guru)"
/>
