...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/flyweight-1.webp"
  alt="Game crash example diagram"
  title="Game crash example diagram (Source: Refactoring Guru)"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/flyweight-2.webp"
  alt="Game example solution diagram"
  title="Game example solution diagram (Source: Refactoring Guru)"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/flyweight-3.webp"
  alt="Game example solution diagram"
  title="Game example solution diagram (Source: Refactoring Guru)"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/flyweight.webp"
  alt="Flyweight structure diagram"
  title="Flyweight structure diagram"
/>
