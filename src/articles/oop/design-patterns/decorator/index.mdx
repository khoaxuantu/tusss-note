...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/decorator.png"
  alt="Social media example diagram"
  title="Social media example diagram (Source: Refactoring Guru)"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/decorator-1.png"
  alt="Solution for social media example"
  title="Solution for social media example (Source: Refactoring Guru)"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/decorator.webp"
  alt="Decorator structure diagram"
  title="Decorator structure diagram"
/>
