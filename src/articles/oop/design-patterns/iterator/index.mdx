...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/iterator-1.webp"
  alt="Iterator solution"
  title="Iterator solution (Source: Refactoring Guru)"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/iterator.webp"
  alt="Iterator structure diagram"
  title="Iterator structure diagram"
/>
