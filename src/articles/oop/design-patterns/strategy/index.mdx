...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/strategy-1.webp"
  alt="Route Strategy solution diagram"
  title="Route Strategy solution diagram (Source: Refactoring Guru)"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/strategy.webp"
  alt="Strategy structure diagram"
  title="Strategy structure diagram"
/>
