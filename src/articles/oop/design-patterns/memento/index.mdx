...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/memento.webp"
  alt="Implementation based on nested classes diagram"
  title="Implementation based on nested classes diagram"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/memento-1.webp"
  alt="Implementation based on an intermediate interface"
  title="Implementation based on an intermediate interface"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/memento-2.webp"
  alt="Implementation with even stricter encapsulation"
  title="Implementation with even stricter encapsulation"
/>
