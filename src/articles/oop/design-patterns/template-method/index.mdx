...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/template-method-1.webp"
  alt="Data mining problem"
  title="Data mining problem (Source: Refactoring Guru)"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/template-method-2.webp"
  alt="Data mining with template method diagram"
  title="Data mining with template method diagram (Source: Refactoring Guru)"
/>
...
<Image
  src="https://ik.imagekit.io/tuslipid/oop/template-method.webp"
  alt="Template method structure diagram"
  title="Template method structure diagram"
/>
